...
group = "dcnlab" # This is the name of the group on Talapas to which your account belongs

# Directories
# You don't need to use slashes in the path names, just put the parts of the path in quotes as shown below.
path_toplevel = os.path.join(os.sep, "projects", "dcnlab", "shared", "bidsWorkshop") # folder that contains path_bidsdata and path_conversionfolder
path_dicoms = os.path.join(os.sep, "projects", "lcni", "dcm", "sanlab", "Berkman", "REV_examples")
...
singularity_image =  os.path.join(os.sep, "projects", "dcnlab", "shared", "containers", "Dcm2Bids-master.simg")